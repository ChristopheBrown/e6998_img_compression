...
flags = tf.app.flags
flags.DEFINE_string('input', 'C:/Users/Donis/Documents/compression/compression_experiment', 'input path')
...
# added these lines from: https://github.com/tensorflow/tensorflow/issues/2825
FLAGS = flags.FLAGS
...
try:
    img = imageio.imread(FLAGS.input).astype(np.float32)
except:
